...
<div className="centered-image-container">
  <img src="/img/install/godaddy/go-daddy-add-custom-section.gif" alt="GoDaddy Installation" />
</div>
```
...
Notice the import statement at the top of this source file. It looks like this:

```ts
import { ChatMessageBubble } from "@xapp/chat-widget";
```

It allows you to use react components, either from an external libary or defined in this project.
...
<ChatMessageBubble owner="others" hasTail>
  I know! React in markdown files!
</ChatMessageBubble>
<br />
