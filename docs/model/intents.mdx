...
Intents are a classification of utterances into a common meaning.  Words like "yeah" or "yes" can be bundled into an intent that communicates confirmation.  Some, like this confirmation style intent, can be used in many different situations.   




A simple analogy is to understand the relationship between intents and handlers is intents are the input and handlers are the output.  